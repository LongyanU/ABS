...
for it=1:nt-2,
    ...
    Vxxabs=coeff2(1)*Vxx+coeff2(2)*Vxx_1+coeff2(3)*Vxx_2+coeff2(4)*Vxx_3;
    Vzzabs=coeff2(1)*Vzz+coeff2(2)*Vzz_1+coeff2(3)*Vzz_2+coeff2(4)*Vzz_3;
    Vzxabs=coeff2(1)*Vzx+coeff2(2)*Vzx_1+coeff2(3)*Vzx_2+coeff2(4)*Vzx_3;
    Vxzabs=coeff2(1)*Vxz+coeff2(2)*Vxz_1+coeff2(3)*Vxz_2+coeff2(4)*Vxz_3;
