...
for it=1:nt-2,
    ...
    Txxxabs=coeff2(1)* Txxx+coeff2(2)* Txxx_1+coeff2(3)*Txxx_2;
    Tzzzabs=coeff2(1)* Tzzz+coeff2(2)* Tzzz_1+coeff2(3)*Tzzz_2;
    Txzzabs=coeff2(1)* Txzz+coeff2(2)* Txzz_1+coeff2(3)*Txzz_2;
    Txzxabs=coeff2(1)* Txzx+coeff2(2)* Txzx_1+coeff2(3)*Txzx_2;
    ...
    Vxxabs=coeff2(1)*Vxx+coeff2(2)*Vxx_1+coeff2(3)*Vxx_2;
    Vzzabs=coeff2(1)*Vzz+coeff2(2)*Vzz_1+coeff2(3)*Vzz_2;
    Vzxabs=coeff2(1)*Vzx+coeff2(2)*Vzx_1+coeff2(3)*Vzx_2;
    Vxzabs=coeff2(1)*Vxz+coeff2(2)*Vxz_1+coeff2(3)*Vxz_2;

    Txx=Txx+dt*rou.*(vp.^2.*Vxxabs+(vp.^2-2*vs.^2).*Vzzabs)/h;
    Tzz=Tzz+dt*rou.*(vp.^2.*Vzzabs+(vp.^2-2*vs.^2).*Vxxabs)/h;
    Txz=Txz+dt*rou.*(vs.^2).*(Vxzabs+Vzxabs)/h;
